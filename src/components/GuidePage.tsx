        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto w-full">
           ...
           <div className="flex justify-center pb-8">
             <a 
                ...
                className="text-slate-500 hover:text-blue-500 dark:text-slate-500 dark:hover:text-blue-400 transition-colors flex items-center gap-1.5 text-sm font-medium border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F1219] px-4 py-2 rounded-full shadow-sm hover:shadow"
              >
                Check out more tools at link.thanhlv.com <ArrowLeft className="w-4 h-4 rotate-180" />
              </a>
           </div>
        </main>
      </div>
